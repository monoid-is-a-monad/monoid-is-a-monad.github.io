...
<div class="hero section-card">
  <div>
    ...
    <div style="margin-top:14px; display:flex; gap:10px; flex-wrap:wrap;">
      <a class="btn primary" href="{{ "/el/contact/" | relative_url }}">Κλείσε μάθημα</a>
      <a class="btn ghost" href="{{ "/el/services/" | relative_url }}">Δες τις υπηρεσίες</a>
    </div>
  ...
  <div class="highlight-box">
    ...
    <p><a class="btn primary" href="{{ "/el/contact/" | relative_url }}">Κλείσε μάθημα</a></p>
  </div>
</div>
